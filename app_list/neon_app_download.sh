...
wget http://download.opensuse.org/repositories/home:/ColinDuquesnoy/xUbuntu_18.04/amd64/mellowplayer_3.5.5-1_amd64.deb
...
wget https://launchpad.net/~webupd8team/+archive/ubuntu/haguichi/+files/haguichi_1.4.1~ubuntu18.04.1_amd64.deb
